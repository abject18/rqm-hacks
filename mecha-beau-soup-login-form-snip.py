...
import html2text
#
# In the post about emulating a browser in python with mechanize I have showed
# you how to make some basic tricks in the web with python, but I have not
# showed how to login a site and how to handle a session, with html forms,
# links and cookies. Here I will show it all for you, let’s see it.
#
